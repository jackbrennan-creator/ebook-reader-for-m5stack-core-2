...
class menu_manager
{
  ...
  protected:
    ...
    const int    menu_font_size  =   2;
    const int    options_top     =  40;
    const int    options_left    =  50;
    const int    spacing         =  20;
    const int    selector_radius =   6;
    const int    selector_top    =  40 + 2 * selector_radius;
    const int    selector_left   =  25;
